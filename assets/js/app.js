...
var deliveryDropdown = document.querySelector('.delivery-dropdown');
if (deliveryDropdown) {
  var deliveryDropdownToggle = function deliveryDropdownToggle(e) {
    e.stopProlo;
...
document.addEventListener('click', function (e) {
  if (e.target.classList.contains('delivery-switch__item')) {
    ...
    var list = control.parentElement;
    var CONTROLS = list.querySelectorAll('.delivery-switch__item');
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var PAGE_SCROLLED_CLASS = 'page-scrolled';
...
function stepperInput(e) {
  ...
  min = incI.getAttribute("min"), max = incI.getAttribute("max"), step = incI.getAttribute("step") * parseInt(sign);
  if (step > 0) {
...
if (toTop) {
  ...
  var goTopBtn = document.querySelector(".to-top__btn");
...
var orderingRadiogroups = Array.from(document.querySelectorAll(".ordering-radiogroup__group"));
orderingRadiogroups.forEach(function (rg, index) {
  ...
  function notify(event) {
    if (event.target !== event.currentTarget) {
      ...
      var allAI = Array.from(org.querySelectorAll(".ordering-radiogroup__additional-info"));
      allAI.forEach(function (ai, index) {
        ai.classList.remove('open');
      });
      var selectedAI = org.querySelector("[data-radioitem='" + sRadio + "']");
      if (selectedAI) selectedAI.classList.add('open');
    }
...
var restScroll = document.querySelector('.restaurant-map__rest-scroller');
if (restScroll) {
  // при инициализации
...
// EXTERNAL MODULE: ./src/assets/js/_delivery-switch.js
var _delivery_switch = __webpack_require__(0);
// EXTERNAL MODULE: ./src/assets/js/_lang-switch.js
var _lang_switch = __webpack_require__(18);
// EXTERNAL MODULE: ./src/assets/js/_main-menu.js
var _main_menu = __webpack_require__(878);
...
;// CONCATENATED MODULE: ./src/assets/js/_slider.js

var homeSlider = new core('.js-home-slider', {
  modules: [Pagination],
  slidesPerView: 'auto',
  centeredSlides: true,
  initialSlide: 1,
...
/////////////////////////////////////////
// menu-list-slider
var root = '.menu-list-slider';
var rootNode = document.querySelector(root);
var activeCategory;
if (rootNode != null) {
  activeCategory = rootNode.dataset.active;
}
var activeIndex = activeCategory > 0 ? parseInt(activeCategory) - 1 : 0;
var headerSliderNav = new core(root, {
...
var sections = document.querySelectorAll('[data-alias]');
if (links) {
  links.forEach(function (link) {
    link.addEventListener('click', function (e) {
      e.preventDefault();
      var target = link.dataset.target;
      var scrollTarget = document.querySelector("[data-alias=\"".concat(target, "\"]"));
      var topOffset = document.querySelector('.header').offsetHeight + 70;
      var realOffset;
      ...
      var blockPosition = scrollTarget.getBoundingClientRect().top;
      var realPosition = blockPosition - realOffset - 15;
  ...
  window.addEventListener('scroll', function () {
    ...
    sections.forEach(function (element, index) {
      if (!current && scrolledIntoView(element)) {
        ...
        var targets = document.querySelectorAll("[data-target='".concat(current, "']"));
...
var itemsFilter = new core('.items-filter__slider', {
  modules: [Scrollbar],
  speed: 500,
  slidesPerView: 'auto',
  spaceBetween: 30,
...
var restMenusSlider = new core('.rest-menus-slider', {
  modules: [Scrollbar],
  speed: 500,
  slidesPerView: 'auto',
  spaceBetween: 20,
...
var newsSlider = new core('.news-slider', {
  modules: [Pagination],
  slidesPerView: 1,
  spaceBetween: 30,
  speed: 1300,
...
var restGallerySlider = new core('.rest-gallery-slider', {
  slidesPerView: 1,
  spaceBetween: 0,
  speed: 1300,
  loop: true,
...
var restNewsSlider = new core('.rest-news-slider', {
...
var restВishesЫlider = new core('.rest-dishes-slider', {
  slidesPerView: 'auto',
  centeredSlides: true,
  initialSlide: 1,
  spaceBetween: 10,
...
var lkMenuSlide = new core('.lk-menu-slider', {
  modules: [Scrollbar],
  speed: 500,
  slidesPerView: 'auto',
  spaceBetween: 10,
...
var compositionSlider = new core('.js-composition-slider', {
  modules: [Scrollbar],
  speed: 500,
  scrollbar: {
    el: '.slider-scrollbar',
...
var centeredSlider = new core('.js-centered-slider', {
  modules: [Navigation],
...
document.addEventListener('candyOpen', function () {
  var candySlider = new core('.js-candy-detail-slider', {
    modules: [Navigation],
    observer: true,
    observeParents: true,
    navigation: {
...
// EXTERNAL MODULE: ./src/assets/js/_menu-list.js
var _menu_list = __webpack_require__(618);
// EXTERNAL MODULE: ./src/assets/js/_ontop.js
var _ontop = __webpack_require__(451);
...
;// CONCATENATED MODULE: ./src/assets/js/_modal.js
...
// EXTERNAL MODULE: ./src/assets/js/_delivery-dropdown.js
var _delivery_dropdown = __webpack_require__(1);
// EXTERNAL MODULE: ./node_modules/jquery/dist/jquery.js
var jquery = __webpack_require__(755);
var jquery_default = /*#__PURE__*/__webpack_require__.n(jquery);
;// CONCATENATED MODULE: ./src/assets/js/_field-multiselect.js


// Поле мультиселекта
jquery_default()('.field-multiselect__wrap_placeholder, .field-multiselect__wrap_chevron').on("click", function () {
  var fs = jquery_default()(this).closest('.field-multiselect');
  jquery_default()(fs).toggleClass('open');
});
jquery_default()('.field-multiselect .field-multiselect__wrap_list .item').on("click", function () {
  jquery_default()(this).attr('data-select', true);
  var fs = jquery_default()(this).closest('.field-multiselect');
  jquery_default()(fs).removeClass('open');
  jquery_default()(fs).addClass('selected');
  mselect_render_val(fs);
});
function mselect_render_val(mselect) {
  var fs = jquery_default()(mselect).closest('.field-multiselect');
  var selected = jquery_default()(fs).find('.field-multiselect__selected');
  jquery_default()(selected).html('');
  var items = jquery_default()(mselect).find('.field-multiselect__wrap_list .item[data-select="true"]');
  if (items.length == 0) {
    jquery_default()(fs).removeClass('selected');
    return;
  }
  items.each(function (index) {
    var item = jquery_default()(this).clone();
    jquery_default()(item).append('<div class="item__remove"></div>');
    jquery_default()(selected).append(item);
  });
  jquery_default()('.field-multiselect .field-multiselect__selected .item__remove').on("click", function () {
    var fs = jquery_default()(this).closest('.field-multiselect');
    var parent = jquery_default()(this).closest('.item');
    var id = jquery_default()(parent).attr('data-id');
    var item = jquery_default()(fs).find('.field-multiselect__wrap_list .item[data-id="' + id + '"]');
    jquery_default()(item).attr('data-select', false);
    mselect_render_val(fs);
  });
}
;// CONCATENATED MODULE: ./src/assets/js/_field-select.js


// Поле селекта
jquery_default()('.field-select__wrap_placeholder, .field-select__wrap_value, .field-select__wrap_chevron').on("click", function (e) {
  var fs = jquery_default()(this).closest('.field-select');
  var isOpen = jquery_default()(fs).hasClass('open');
  jquery_default()('.field-select').removeClass('open');
  jquery_default()(fs).toggleClass('open', !isOpen);
  e.stopPropagation();
});
jquery_default()('.field-select .field-select__wrap_list .item').on("click", function () {
  var val = jquery_default()(this).html();
  var fs = jquery_default()(this).closest('.field-select');
  jquery_default()(fs).find('.item').removeClass('active');
  jquery_default()(this).addClass('active');
  jquery_default()(fs).removeClass('open');
  jquery_default()(fs).addClass('selected');
  jquery_default()(fs).find('.field-select__wrap_value').html(val);
});
jquery_default()('.field-select__wrap_clear').on("click", function () {
  var fs = jquery_default()(this).closest('.field-select');
  jquery_default()(fs).removeClass('selected');
  jquery_default()(fs).find('.field-select__wrap_value').html('');
});
...
// EXTERNAL MODULE: ./src/assets/js/_fieldtext.js
var _fieldtext = __webpack_require__(496);
// EXTERNAL MODULE: ./src/assets/js/_header.js
...
;// CONCATENATED MODULE: ./src/assets/js/_air-datepicker.js

var date = new index_es('.date-widjet');
var datetime = new index_es('.datetime-widjet', {
  timepicker: true,
  timeFormat: 'HH:mm',
  minHours: 9,
  maxHours: 24,
...
;// CONCATENATED MODULE: ./src/assets/js/_imask.js
...
window.onload = function () {
  ...
  if (counters) {
    counters.forEach(function (counter) {
      ...
      var val = parseInt(counter.getAttribute("data-val"));
      var countUp = new countUp_min_i(counter, val, options);
      countUp.start();
    });
  }
};
